...
<!-- Mirrored from code-theme.com/php/findhouses/dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Sep 2021 11:02:54 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="container-fluid">
                            ...
                            <nav id="navigation" class="style-1">
                                ...
                                <li><a href="#">Home</a>
                                    <ul>
                                        <li><a href="#">Home Map</a>
                                            <ul>
                                                ...
                                                <li><a href="index-21.php">Home Map Style 3</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Home Image</a>
                                            <ul>
                                               <li><a href="index.php">Modern Home</a></li>
                                                ...
                                                <li><a href="index-6.php">Home Parallax Image</a></li>
                                        ...
                                        <ul>
                                            <li><a href="#">Listing Grid</a>
                                                <ul>
                                                    ...
                                                    <li><a href="properties-full-grid-2.php">Grid Fullwidth 2</a></li>
                                            ...
                                            <li><a href="#">Agent View</a>
                                                <ul>
                                                    <li><a href="agents-listing-grid.php">Agent View 1</a></li>
                                    ...
                                    <li><a href="#">Property</a>
                                        <ul>
                                            <li><a href="single-property-1.php">Single Property 1</a></li>
                                            <li><a href="single-property-2.php">Single Property 2</a></li>
                                            <li><a href="single-property-3.php">Single Property 3</a></li>
                                            <li><a href="single-property-4.php">Single Property 4</a></li>
                                            <li><a href="single-property-5.php">Single Property 5</a></li>
                                    ...
                                    <li><a href="#">Blog</a>
                                        <ul>
                                            <li><a href="#">Grid Layout</a>
                                                <ul>
                                                    <li><a href="blog-full-grid.php">Full Grid</a></li>
                        ...
                        <div class="header-user-menu user-menu">
                            <div class="header-user-name">
                                <span><img src="images/testimonials/ts-.jpg" alt=""></span>Hi, Mary!
                            </div>
                            <ul>
                    ...
                    <div class="col-lg-3 col-md-12 col-xs-12 pl-0 pr-0 user-dash">
                        <div class="user-profile-box mb-0">
                            ...
                            <div class="header clearfix">
                                <img src="images/testimonials/ts-.jpg" alt="avatar" class="img-fluid profile-img">
                            </div>
...
<!-- Mirrored from code-theme.com/php/findhouses/dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Sep 2021 11:02:55 GMT -->
</html>
