...
<!-- Mirrored from code-theme.com/html/findhouses/properties-list-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Sep 2021 11:02:05 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="pro-wrapper">
                                ...
                                <div class="cod-pad single detail-wrapper mr-2 mt-0 d-flex justify-content-md-end align-items-center grid">
                                    ...
                                    <div class="sorting-options">
                                        <a href="properties-grid.php" class="change-view-btn active-view-btn"><i class="fa fa-th-list"></i></a>
                                        <a href="properties-list-1.php" class="change-view-btn lde"><i class="fa fa-th-large"></i></a>
                                    </div>
                                </div>
                            </div>
                        </section>
...
?>
									 ...
									 <div class="project-bottom">
                                        ...
                                        <div class="homes">
                                           ...
                                           <a href="single-property-detail.php?proid=<?php echo $row['ID'];?>">
											...
											<img src="propertyimages/<?php echo $row['FeaturedImage'];?>" width="380" height="300">
                                        </div>
                            ...
                            <div class="col-lg-7 col-md-12 homes-content pb-0 mb-44" data-aos="fade-up">
                                <!-- homes address -->
                                <h3><a href="single-property-detail.php?proid=<?php echo $row['ID'];?>">
...
<?php }?>
                            ...
                            <div class="item col-lg-5 col-md-12 col-xs-12 landscapes sale pr-0 pb-0">
                                <div class="project-single mb-0 bb-0" data-aos="fade-up"> <?php
