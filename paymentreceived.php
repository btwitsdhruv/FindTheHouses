...
$ret=mysqli_query($con,"select * from  payment where owner_id='$uid' ");
...
?>
                  ...
                  <td><a href="view-receivedpayment-detail.php?viewid=<?php echo $row['owner_id'];?>"><i class="fas fa-edit"></i></a>view</td>
                                            <div class="inner">
                                               </div></TD>
											   </TR>
                                </tbody>
