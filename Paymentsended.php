...
$ret=mysqli_query($con,"select * from  payment where user_id='$uid' ");
...
?>
                  ...
                  <td><a href="view-payment-detail.php?viewid=<?php echo $row['user_id'];?>"> <i class="fa fa-eye" aria-hidden="true"></i>View Details</a></td>
                                            <div class="inner">
                                               </div></TD>
											   </TR>
                                </tbody>
