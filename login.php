...
<!-- Mirrored from code-theme.com/php/findhouses/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Sep 2021 11:02:58 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <header id="header-container">
            ...
            <div id="header">
                <div class="container container-header">
                    ...
                    <!-- Right Side Content / End -->
                    <div class="header-0-menu user-menu add">
        ...
        <div id="login">
            <div class="login">
                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
					...
					<button type="submit" name="submit" class="btn_1 rounded full-width">Login to Find Houses
					<a href=""  ></a>
                   </button>
