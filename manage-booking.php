                        ...
                        <div class="my-properties">
                            <table class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($con, "select * from tblbooking where owner='$uid'");
                                    ...
                                    ?>
                                            <tr>
                                               ...
                                               <td><a href="details.php?viewid=<?php echo $row['BookingNumber'];?>"><i class="fa fa-eye" aria-hidden="true"></i>view
</td>
