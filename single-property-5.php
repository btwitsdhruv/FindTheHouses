...
$message=$_POST['message'];
$status=0;
$query=mysqli_query($con,"insert into tblbooking(UserId,PropertyId,FromDate,ToDate,message,Status) value('$uid','$pid','$fromdate','$todate','$message','$status')");
                                ...
                                <section class="headings-2 pt-0">
                                    <div class="pro-wrapper">
                                        ...
                                        <div class="single detail-wrapper mr-2">
                                            <div class="detail-wrapper-body">
                                                <div class="listing-title-bar">
                                                    <h4><?php echo $row['RentorsalePrice'];?></h4>
                                                    <div class="mt-0">
                                                        <a href="#listing-location" class="listing-address">
...
<?php }?>
                        ...
                        <div class="property-location map">
                            ...
                            <div id="gmap_canvas" class="gmap_canvas"><iframe width="700" height="500" id="gmap_canvas" src="<?php echo (isset($firstname2))?$firstname2:'';?>" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net/text-tools/"></a></div><style>.mapouter{position:relative;text-align:right;height:500px;width:1270px;}.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:1270px;}</style>
</div>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <input type="submit" class="btn reservation btn-radius theme-btn full-width mrg-top-10"  name="book" value="Book Now">
                                   ...
                                   <a href="payment-method.php" class="btn reservation btn-radius theme-btn full-width mrg-top-10">Payment</a> -->
...
?>
                                        ...
                                        <div class="recent-main">
                                            <div class="recent-img">
                                                <img src="propertyimg/<?php echo $row['FeaturedImage'];?>" alt="<?php echo $row['PropertyTitle'];?>" >
                                            </div>
                                            <div class="info-img">
                                                <a href="#"><h6><?php echo $row['PropertyTitle'];?></h6></a>
                                                <p><?php echo $row['RentorsalePrice'];?></p>
                                            </div>
                                        </div>
<?php }?>
                                        <div class="recent-main my-4">
                                            <div class="recent-img mt">
																									                                 <?php
...
?>
                                ...
                                <div class="widget-boxed-body">
                                    <div class="slick-lancers">
                                        <div class="agents-grid mt-auto">
                                            <div class="listing-item compact h-100 ">
																		                                 <?php
...
{
?>
                                               <a href="single-property-2.php?proid=<?php echo $row['ID'];?>" class="listing-img-container">
                                                ...
                                                <span><?php echo $row['Bedrooms'];?></span>
                                                    ...
                                                    <img src="propertyimg/<?php echo $row['FeaturedImage'];?>" alt="<?php echo $row['PropertyTitle'];?>"  width='380' height='500'>
                                                </a>
<?php }?>
                                            </div>
                                        </div>	
                                        ...
                                        <div class="agents-grid mr-0">
                                            <div class="listing-item compact  h-100 p-4">
                                                					                                 <?php
...
?>
                                               <a href="single-property-2.php?proid=<?php echo $row['ID'];?>" class="listing-img-container">
                                                ...
                                                <span><?php echo $row['Bedrooms'];?></span>
                                                    ...
                                                    <img src="propertyimg/<?php echo $row['FeaturedImage'];?>" alt="<?php echo $row['PropertyTitle'];?>"  width='300' height='500'>
                                                </a>
<?php }?>
                                            </div>
                                        </div>
...
<?php }?>
                                   ...
                                   <div class="form-group">
				<form method="POST">
					<input type="text" name="code" class="form-control" value="https://api.qrserver.com/v1/create-qr-code/?size=350x350&data=<?php echo (isset($firstname))?$firstname:'';?>">
					
					<br >
					<button class="btn btn-primary form-control" href="https://api.qrserver.com/v1/create-qr-code/?size=350x350&data=<?php echo $row['$firstname'];?>" name="generate" >Generate</button>
				</form>
				...
				?>
					<center><img src="https://api.qrserver.com/v1/create-qr-code/?size=350x350&data=<?php echo $_POST['code']?>" alt=""></center>
				<?php
						}
					}
				?>
						...
						click on this link
						<input type="text" name="link" class="form-control" value="<?php echo (isset($firstname))?$firstname:'';?>">
					
                   <button class="btn btn-primary form-control"  >click on this link</button>          <!-- End: Specials offer -->
                                 </button> 
                                </div>
                            </div>
                        </div>
...
?>
                                    <div class="project-inner project-head">
                                        ...
                                        <div class="button-effect">
                                            <a href="single-property-2.php" class="btn"><i class="fa fa-link"></i></a>
                                            <a href="https://www.youtube.com/watch?v=2xHQqYRcrx4" class="btn popup-video popup-youtube"><i class="fas fa-video"></i></a>
                                            <a href="single-property-2.php" class="img-poppu btn"><i class="fa fa-photo"></i></a>
                                        </div>
                                    </div>
                                    <!-- homes content -->
